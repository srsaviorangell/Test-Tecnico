                ...
                <div id="card-das-inf-gertal" className="gap-2 flex flex-col items-center justify-start w-full h-full">
                    ...
                    <div id=" conteiner-dados-gel" className=" sm:gap-3 flex  items-center pl-5 w-full h-35">
                        <div id="if-relação" className="flex  flex-col items-center w-max h-full">
                            <div className="flex items-center font-semibold  text-[12px] sm:ml-2 w-full h-full"><h1>Data de Lançamento:</h1></div>
                            <div className="flex items-center font-semibold  text-[12px] sm:ml-2 w-full h-full"><h1>Episodio:</h1></div>
                            <div className="flex items-center font-semibold  text-[12px] sm:ml-2 w-full h-full"><h1>Diretor:</h1></div>
                            <div className="flex items-center font-semibold  text-[12px] sm:ml-2 w-full h-full"><h1>Produtor:</h1></div>
                        </div>
