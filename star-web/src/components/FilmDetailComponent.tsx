        ...
        <>
            ...
            <div id="card-detalhe" className="gap-3 flex flex-col items-center justify-start h-full w-[55vw]  rounded-[22px] bg-green-900/10 border border-green-500/50 backdrop-blur-xs  mb-8 pb-3" >
                ...
                <div id="card-das-inf-gertal" className="gap-2 flex flex-col items-center justify-start w-full h-full">
                    <div id="nome filme" className="flex w-full h-max pt-4 pl-2 sm:pl-5">
                        <h1 className="font-bold">{t(`nomes.${informacao.titulo}`)}</h1>
                    </div>
                    <div id=" conteiner-dados-gel" className=" sm:gap-3 flex  items-center pl-5 w-full h-35">
                        <div id="if-relação" className="flex  flex-col items-center w-max h-full">
                            <div className="flex items-center font-semibold  text-[12px] sm:ml-2 w-full h-full"><h1>{t('Data de Lançamento')}:</h1></div>
                            <div className="flex items-center font-semibold  text-[12px] sm:ml-2 w-full h-full"><h1>{t('Episódio')}:</h1></div>
                            <div className="flex items-center font-semibold  text-[12px] sm:ml-2 w-full h-full"><h1>{t('Diretor')}:</h1></div>
                            <div className="flex items-center font-semibold  text-[12px] sm:ml-2 w-full h-full"><h1>{t('Produtor')}:</h1></div>
                        </div>
                        <div id="if-alimenta-relação" className="flex  flex-col items-center  w-max h-full">
                            <div className="flex items-center text-[12px] w-full h-full"><h1>{t(`dataBR.${informacao.dataLancamento}`)}</h1></div>
                ...
                <div id="card-das-inf-personagem" className="gap-2 flex flex-col  w-full h-ful">
                    <div id="descrição personagem " className="font-bold flex  w-full h-max  pt-4 pl-2 sm:pl-5">
                        <h1>{t('Personagens')}</h1>
                    </div>
